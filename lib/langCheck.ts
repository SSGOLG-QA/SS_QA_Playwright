...
export const MENU_LIST: { menu: string; subs: string[] }[] = [
  { menu: '골프장 정보', subs: ['로컬룰 및 유의사항'] },   // ✎ 추가(2026-07-30): 로컬룰 및 유의사항 다국어 검증 대상
  { menu: '라운드관리', subs: ['내장 현황', '내장 통계', '전체 라운드', '라운드 설정', '카트 관리', '홀별 정산 관리', '스코어 출력 설정', '마커 인증 조회'] },   // ✎ '마커 인증 조회' 추가(2026-07-30) · '스코어 출력 설정' 추가(2026-08-18, 라이브 확정·스크립트화)
  ...
  { menu: '고객 평가 관리', subs: ['캐디 평가', '고객 평가', '식음료 평가', '골프장 평가', '후기 리스트', '후기 통계'] },   // ✎ '골프장 평가' 추가(2026-07-30, td18 SNB)
  { menu: '대회', subs: ['대회관리'] },
